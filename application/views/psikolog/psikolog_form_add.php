                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-md-0">
                                                <div class="form-group">
                                                    <input type="hidden" name="idpsikolog">
                                                    <label for="namaPsikolog">Nama Lengkap</label>
                                                    <input type="text" name="namaPsikolog" class="form-control <?=form_error('namaPsikolog') ? 'is-invalid' : null ?>" id="namaPsikolog" value="<?php echo set_value('namaPsikolog'); ?>">
